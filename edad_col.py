...
Original file is located at
    https://colab.research.google.com/drive/1GUeDvkcGSAetXKb0kBKIu5B8KEFhcQTG
"""
...
df=pd.read_csv('colombia.csv',encoding='UTF-8')
